...
class Quickbuild extends Component  {
  render(){
    return (
      <div>
        <div>
          <p className="Product-word-left">Git版本控制仓库</p>
        ...
        <div className="Product-imgQuickBuid" alt="NO IMG" ><div className="Product-word"><Icon type="github" className="Product-Icon" theme="outlined" /></div><p className="Product-word">Git是一个开源的分布式版本控制系统，可以有效、高速的处理从很小到非常大的项目版本管理。</p></div>
        <div>
